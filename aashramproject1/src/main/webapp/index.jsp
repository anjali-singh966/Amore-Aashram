...
<body>
        ...
        <div class="d-flex flex-wrap justify-content-between align-items-center">
          <ul class="info d-flex flex-wrap list-unstyled m-0">
            <li class="location text-capitalize d-flex align-items-center me-4" style="font-size: 14px;">
              ...
              </svg>State Road 54 Hajipur, Vaishali
            </li>
      ...
      <div class="container-fluid padding-side">
        <div class="d-flex justify-content-between align-items-center w-100">
          <a class="navbar-brand" href="index.html">
            <h1 class="logo img-fluid">Amor Aasharam </h1>
          </a>
          ...
          <div class="header-bottom offcanvas offcanvas-end " id="bdNavbar" aria-labelledby="bdNavbarOffcanvasLabel">
            ...
            <div class="offcanvas-body align-items-center justify-content-center">
              ...
              <ul class="navbar-nav align-items-center mb-2 mb-lg-0">
                ...
                <li class="nav-item px-3">
                  <a class="nav-link p-0" href="aboutus.jsp">About</a>
                </li>
                <li class="nav-item px-3">
                  <a class="nav-link p-0" href="services.jsp">Services</a>
                </li>
                <li class="nav-item px-3">
                  <a class="nav-link p-0" href="blog.jsp">Blog</a>
                </li>
                <li class="nav-item px-3">
                  <a class="nav-link p-0" href="contact.jsp">Contact</a>
                </li>
                <li class="nav-item px-3 dropdown">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end animate slide mt-3 border-0 shadow">
                    <li><a href="aboutus.jsp" class="dropdown-item ">About </a>
                    </li>
                    <li><a href="room.jsp" class="dropdown-item ">Room </a>
                    </li>
                    <li><a href="room-details.jsp" class="dropdown-item">Room-Details
                        </a></li>
                    <li><a href="blog.jsp" class="dropdown-item ">Blog </a>
                    </li>
                    <li><a href="blog-single" class="dropdown-item ">Blog-Single </a></li>
                    <li><a href="services.jsp" class="dropdown-item ">Services </a></li>
                    <li><a href="services-details.jsp" class="dropdown-item ">Service-Details
                        </a></li>
                    <li><a href="booking.jsp" class="dropdown-item ">Booking </a></li>
                    <li><a href="gallery.jsp" class="dropdown-item ">Gallery </a></li>
                    <li><a href="contact.jsp" class="dropdown-item ">Contact </a></li>
                    <li><a href="team.jsp" class="dropdown-item ">Team </a>
                    </li>
                    <li><a href="reviews.jsp" class="dropdown-item ">Reviews </a></li>
                    <li><a href="faq.jsp" class="dropdown-item ">FAQs </a>
                    </li>
                  </ul>
                </li>
              </ul>
  ...
  <section id="slider" data-aos="fade-up">
    <div class="container-fluid padding-side">
      <div class="d-flex rounded-5"
        style="background-image: url(https://i.pinimg.com/736x/53/b6/91/53b691c0ed26839a56678dd5ddca404e.jpg); background-size: cover; background-repeat: no-repeat; height: 85vh; background-position: center;">
        <div class="row align-items-center m-auto pt-5 px-4 px-lg-0">
          <div class="text-start col-md-6 col-lg-5 col-xl-6 offset-lg-1">
            <h2 class="display-1 fw-normal">Travel with Dignity, Stay with Comfort</h2>
            <a href="room.jsp" class="btn btn-arrow btn-primary mt-3">
  ...
  <section id="about-us" class="padding-large">
    <div class="container-fluid padding-side" data-aos="fade-up">
      <h3 class="display-3 text-center fw-normal col-lg-4 offset-lg-4">Travel with Dignity, Stay with Comfort</h3>
      <div class="row align-items-start mt-3 mt-lg-5">
        <div class="col-lg-6">
          <div class="p-5">
            <p>Welcome to Amore Aashram, where comfort meets tranquility. Nestled in the heart of a bustling city, our
              aashram offers a peaceful retreat for both business and leisure travelers. With modern amenities, and a
          ...
          <img src="https://i.pinimg.com/736x/3a/56/f8/3a56f82f885b15a33d69d640b2353043.jpg" alt="img" class="img-fluid rounded-4 mt-4">
        </div>
        <div class="col-lg-6 mt-5 mt-lg-0">
          <img src="https://i.pinimg.com/474x/92/5f/cc/925fccb83b976655ff636a84885cc145.jpg" alt="img" class="img-fluid rounded-4">
          <img src="https://i.pinimg.com/474x/22/94/51/2294517b178a22927fbc342954b063b3.jpg" alt="img" class="img-fluid rounded-4 mt-4">
        ...
        <div class="swiper-wrapper">
          <div class="swiper-slide">
            <div class="room-item position-relative bg-black rounded-4 overflow-hidden">
              <img src="https://i.pinimg.com/474x/54/07/6e/54076e9c9f2a88e1fedbb306d2c965a2.jpg" alt="img" class="post-image img-fluid rounded-4">
                ...
                <table>
                  <tbody>
                    <tr class="text-white">
                      ...
                      <td class="price">800 /Pernight</td>
                    </tr>
                    <tr class="text-white">
            ...
            <div class="room-content text-center mt-3">
              ...
              <p><span class="text-primary fs-4">1500</span>/night</p>
            </div>
          </div>
          <div class="swiper-slide">
            <div class="room-item position-relative bg-black rounded-4 overflow-hidden">
              <img src="https://i.pinimg.com/736x/38/90/73/3890732f1b88b1b329dc57ef39aadad0.jpg" alt="img" class="post-image img-fluid rounded-4">
              <div class="product-description position-absolute p-5 text-start">
                ...
                <table>
                  <tbody>
                    <tr class="text-white">
                      <td class="pe-2">Price:</td>
                      <td class="price">2000 /Pernight</td>
                    </tr>
                    <tr class="text-white">
                      <td class="pe-2">Size:</td>
                      <td>10 ft</td>
            ...
            <div class="room-content text-center mt-3">
              ...
              <p><span class="text-primary fs-4">2000</span>/night</p>
            </div>
          </div>
          <div class="swiper-slide">
            <div class="room-item position-relative bg-black rounded-4 overflow-hidden">
              <img src="https://i.pinimg.com/474x/db/df/ca/dbdfca1ce6b331f10b7156ca7c6543ef.jpg" alt="img" class="post-image img-fluid rounded-4">
              <div class="product-description position-absolute p-5 text-start">
            ...
            <div class="room-content text-center mt-3">
              ...
              <p><span class="text-primary fs-4">800</span>/night</p>
            </div>
          </div>
          <div class="swiper-slide">
            <div class="room-item position-relative bg-black rounded-4 overflow-hidden">
              <img src="https://i.pinimg.com/474x/35/93/00/359300de4fe5b9b80d54cbe06c66a63a.jpg" alt="img" class="post-image img-fluid rounded-4">
              <div class="product-description position-absolute p-5 text-start">
                <h4 class="display-6 fw-normal text-white">Grand deluxe rooms</h4>
                <p class="product-paragraph text-white">Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                  Molestiae at illum ipsum similique doloribus.</p>
                <table>
                  <tbody>
                    <tr class="text-white">
                      <td class="pe-2">Price:</td>
                      <td class="price"> 1500/Pernight</td>
                    </tr>
                    <tr class="text-white">
                      <td class="pe-2">Size:</td>
                      <td>10 ft</td>
          ...
          <div class="swiper-slide">
            <div class="room-item position-relative bg-black rounded-4 overflow-hidden">
              <img src="https://i.pinimg.com/736x/f9/7f/e8/f97fe8e07c6e7d7370266e09042a2189.jpg" alt="img" class="post-image img-fluid rounded-4">
              <div class="product-description position-absolute p-5 text-start">
                <h4 class="display-6 fw-normal text-white">Sweet Family room</h4>
                <p class="product-paragraph text-white">Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                  Molestiae at illum ipsum similique doloribus.</p>
    ...
    <div class="container position-relative">
      <div class="row">
        <div class="swiper gallery-swiper offset-1 col-10">
          <div class="swiper-wrapper">
            <div class="swiper-slide">
              <img src="https://i.pinimg.com/1200x/6f/81/a4/6f81a472c45b3327010f558cc5bab999.jpg" alt="img" class="img-fluid rounded-4">
            </div>
            <div class="swiper-slide">
              <img src="https://i.pinimg.com/1200x/a0/5e/70/a05e704de2011a285f5f8b13d1651b71.jpg" alt="img" class="img-fluid rounded-4">
            </div>
            <div class="swiper-slide">
              <img src="https://i.pinimg.com/1200x/5f/8f/90/5f8f905691b0603c96c8bcb65f47f476.jpg" alt="img" class="img-fluid rounded-4">
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="row mt-5">
        <div class="col-md-6 col-lg-4 mb-4">
          <div class="blog-post position-relative overflow-hidden rounded-4">
            <img src="https://i.pinimg.com/736x/f8/10/9b/f8109b01080e234d4489a65676991771.jpg" class="blog-img img-fluid rounded-4" alt="img">
        ...
        <div class="col-md-6 col-lg-4 mb-4">
          <div class="blog-post position-relative overflow-hidden rounded-4">
            <img src="https://i.pinimg.com/736x/29/1b/a8/291ba8ae1db4f17e2d28e883ea7cf58d.jpg" class="blog-img img-fluid rounded-4" alt="img">
            <div class="position-absolute bottom-0 p-5">
        ...
        <div class="col-md-6 col-lg-4 mb-4">
          <div class="blog-post position-relative overflow-hidden rounded-4">
            <img src="https://i.pinimg.com/736x/83/4f/34/834f341ea02ce75cf8cba8596144d202.jpg" class="blog-img img-fluid rounded-4" alt="img">
            <div class="position-absolute bottom-0 p-5">
        ...
        <div class="col-md-6 col-lg-8 mb-4">
          <div class="blog-post position-relative overflow-hidden rounded-4">
            <img src="https://i.pinimg.com/736x/2f/63/25/2f63256e8f09e7a8864d967b0fd9e89d.jpg" class="blog-img img-fluid rounded-4" alt="img">
        ...
        <div class="col-md-6 col-lg-4 mb-4">
          <div class="blog-post position-relative overflow-hidden rounded-4">
            <img src="https://i.pinimg.com/736x/e3/34/23/e334234e7051434386e37d508b63ac0a.jpg" class="blog-img img-fluid rounded-4" alt="img">
            <div class="position-absolute bottom-0 p-5">
              <a href="#"><span class="bg-secondary text-body m-0 px-2 py-1 rounded-2 fs-6">Rooms</span></a>
      ...
      <footer class="row">
        <div class="col-md-6 col-lg-3 mb-4 mb-lg-0">
          ...
          <ul class="nav flex-column">
            ...
            <li class="nav-item"><a href="aboutus.jsp" class="p-0 "> About us </a></li>
            <li class="nav-item"><a href="services.jsp" class="p-0 "> Our Services </a></li>
            <li class="nav-item"><a href="privacypolicy.jsp" class="p-0 "> Privacy Policy</a></li>
            <li class="nav-item"><a href="contact.jsp" class="p-0 "> Contact us </a></li>
            <li class="nav-item"><a href="support.jsp" class="p-0 "> Support </a></li>
          </ul>
        </div>
        <div class="col-md-6 col-lg-3 offset-lg-1 mb-4 mb-lg-0">
          <h4 class="display-6 fw-normal">Services</h4>
          <ul class="nav flex-column">
            <li class="nav-item"><a href="spa.jsp" class="p-0 "> Spa </a></li>
            <li class="nav-item"><a href="pool.jsp" class="p-0 "> Pool </a></li>
            <li class="nav-item"><a href="yoga.jsp" class="p-0 "> Yoga </a></li>
            <li class="nav-item"><a href="gym.jsp" class="p-0 "> Gym</a></li>
            <li class="nav-item"><a href="news.jsp" class="p-0 "> News </a></li>
            <li class="nav-item"><a href="terms.jsp" class="p-0 "> Terms & Conditions </a></li>
          </ul>
        </div>
        <div class="col-md-6 col-lg-3 offset-lg-1 mb-4 mb-lg-0">
          <p class="m-0">© Copyright 2024 Amor Aashram. </p>
